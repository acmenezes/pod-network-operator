...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinkAttributes) DeepCopyInto(out *LinkAttributes) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LinkAttributes.
func (in *LinkAttributes) DeepCopy() *LinkAttributes {
	if in == nil {
		return nil
	}
	out := new(LinkAttributes)
	in.DeepCopyInto(out)
	return out
}
